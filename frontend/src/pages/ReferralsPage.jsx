...
export default function ReferralsPage() {
  ...
  const translations = {
    ...
    ar: {
      ...
      subtitle: "كود الدعوة ديالك والأرباح",
      back: "رجوع للداشبورد",
      loading: "كنحمّلو...",
      errorPrefix: "خطأ",
      codeTitle: "كود الدعوة ديالك",
      codeHint: "شارك هاد الكود، كتاخد 10% من الإيداعات المؤكدة ديال اللي عيطتي ليهم.",
      copy: "نسخ",
      invitedCount: "التسجيلات بالكود ديالك",
      bonus: "أرباح الدعوة",
      listTitle: "لائحة المدعوين",
      listCount: "مسجل",
      emptyList: "ما كاين حتى واحد استعمل الكود ديالك.",
      colUser: "المستخدم",
      colEmail: "الإيميل",
