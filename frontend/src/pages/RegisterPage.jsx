...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center relative overflow-hidden" dir={language === "ar" ? "rtl" : "ltr"}>
      ...
      <div className="w-4/5 h-3/4 bg-white/80 backdrop-blur-xl rounded-xl sm:rounded-2xl shadow-2xl shadow-purple-500/20 border border-white/20 p-8 sm:p-6 relative z-10 overflow-y-auto">
        {/* Bouton retour */}
        <Link
          to="/"
        ...
        >
          <img
            src="/app-icon.png"
            alt="Windelevery"
            className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl sm:rounded-2xl object-cover shadow"
          />
        </div>
        <h1 className="text-2xl sm:text-3xl font-bold text-center mb-1 text-slate-900">
          {t.registerTitle}
        </h1>
